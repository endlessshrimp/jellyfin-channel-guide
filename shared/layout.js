...
(() => {
    ...
    const OWN_SCREEN = /^#!?\/(weather|rooms|cameras|planes|sports|news|books|music|radio|playing)(\?|$)/i;
    ...
    const whereAmI = () => {
        ...
        if (/^#\/radio(\?|$)/.test(h)) return { tab: null, name: 'Radio' };
